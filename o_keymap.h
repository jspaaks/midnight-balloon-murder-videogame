...
void o_keymap_draw_proceedhint (ctx_t, counters_t, SDL_Renderer *, scene_t, fonts_t, colors_t, ground_t);
void o_keymap_draw_quit (SDL_Renderer *, scene_t, fonts_t, colors_t, turret_t, ground_t);
void o_keymap_draw_restart (ctx_t, counters_t, SDL_Renderer *, scene_t, fonts_t, colors_t, turret_t, ground_t);
