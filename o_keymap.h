...
void o_keymap_draw_proceedhint (ctx_t, SDL_Renderer *, fonts_t, colors_t, scene_t, ground_t, counters_t);
void o_keymap_draw_quit (SDL_Renderer *, fonts_t, colors_t, scene_t, turret_t, ground_t);
void o_keymap_draw_restart (ctx_t, SDL_Renderer *, fonts_t, colors_t, scene_t, turret_t, ground_t, counters_t);
