...
chunks_t chunks_init (char * basepath) {
    ...
    sprintf(filename, "%s../assets/chunks/empty.wav", basepath);
    ...
    sprintf(filename, "%s../assets/chunks/hit-red.wav", basepath);
    ...
    sprintf(filename, "%s../assets/chunks/hit-orange.wav", basepath);
    ...
    sprintf(filename, "%s../assets/chunks/hit-yellow.wav", basepath);
    ...
    sprintf(filename, "%s../assets/chunks/pop.wav", basepath);
    ...
    sprintf(filename, "%s../assets/chunks/shot.wav", basepath);
