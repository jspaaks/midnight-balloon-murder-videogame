...
void drawable_keymap_draw_proceedhint (level_t, SDL_Renderer *, fonts_t, colors_t, scene_t,
                                       ground_t, counters_t);
void drawable_keymap_draw_quit (SDL_Renderer *, fonts_t, colors_t, scene_t, turret_t,
                                ground_t);
void drawable_keymap_draw_restart (level_t, SDL_Renderer *, fonts_t, colors_t, scene_t, turret_t,
                                   ground_t, counters_t);
void drawable_keymap_draw_shoot (SDL_Renderer *, fonts_t, colors_t, scene_t, turret_t,
                                 ground_t);
