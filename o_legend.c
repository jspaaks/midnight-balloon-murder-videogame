...
static void o_legend_draw_bars (ctx_t *, SDL_Renderer *);
static void o_legend_draw_rect_nbullets (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_hit (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_level (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_miss (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_nballoons (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_nbullets (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_nhit (ctx_t *, SDL_Renderer *);
static void o_legend_draw_text_nmiss (ctx_t *, SDL_Renderer *);

static void o_legend_draw_bars (ctx_t * ctx, SDL_Renderer * renderer) {
    int j = 0;
    ...
    SDL_SetRenderDrawColor(renderer, ctx->colors.hit.r,
                                     ctx->colors.hit.g,
                                     ctx->colors.hit.b,
                                     ctx->colors.hit.a);
    ...
    SDL_SetRenderDrawColor(renderer, ctx->colors.middlegray.r,
    ...
    SDL_SetRenderDrawColor(renderer, ctx->colors.miss.r,
                                     ctx->colors.miss.g,
                                     ctx->colors.miss.b,
                                     ctx->colors.miss.a);
...
static void o_legend_draw_rect_nbullets (ctx_t * ctx, SDL_Renderer * renderer) {
    ...
    SDL_SetRenderDrawColor(renderer, ctx->legend.highlight.bg->r,
...
static void o_legend_draw_text_hit (ctx_t * ctx, SDL_Renderer * renderer) {
...
static void o_legend_draw_text_level (ctx_t * ctx, SDL_Renderer * renderer) {
    char level[30];
...
static void o_legend_draw_text_miss (ctx_t * ctx, SDL_Renderer * renderer) {
...
static void o_legend_draw_text_nballoons (ctx_t * ctx, SDL_Renderer * renderer) {
...
static void o_legend_draw_text_nbullets (ctx_t * ctx, SDL_Renderer * renderer) {
    char nbullets[30];
...
static void o_legend_draw_text_nhit (ctx_t * ctx, SDL_Renderer * renderer) {
    char nhit[30];
...
static void o_legend_draw_text_nmiss (ctx_t * ctx, SDL_Renderer * renderer) {
    char nmiss[30];
...
void o_legend_draw (ctx_t * ctx, SDL_Renderer * renderer) {
    o_legend_draw_bars(ctx, renderer);
    o_legend_draw_rect_nbullets(ctx, renderer);
    o_legend_draw_text_nbullets(ctx, renderer);
    o_legend_draw_text_hit(ctx, renderer);
    o_legend_draw_text_miss(ctx, renderer);
    o_legend_draw_text_nhit(ctx, renderer);
    o_legend_draw_text_nmiss(ctx, renderer);
    o_legend_draw_text_nballoons(ctx, renderer);
    o_legend_draw_text_level(ctx, renderer);
}
