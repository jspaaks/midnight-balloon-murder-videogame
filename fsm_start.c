...
void fsm_start_draw (ctx_t, drawing_t drawing, drawables_t drawables) {
...
void fsm_start_update (timing_t, ctx_t * ctx, SDL_Window * window, drawing_t * drawing, drawables_t *, gamestate_t ** gamestate) {
    SDL_Event event;
